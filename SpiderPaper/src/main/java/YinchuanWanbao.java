 ...
 */
public class YinchuanWanbao {

    SaveXML savexml = new SaveXML();

    public YinchuanWanbao( String newspaper ) {
    ...
    public void getNewsInfo( String NewsUrl ) { 	//获得新闻来源URL
        try {
            ...
            Elements IMGs = TitleEle.parent().parent().parent().parent().parent().parent().parent().select("img[src]");
