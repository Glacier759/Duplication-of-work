 ...
 */
public class NeimengguRibao {

    SaveXML savexml = new SaveXML();

    public NeimengguRibao( String newspaper ) {
    ...
    public void getNewsInfo( String NewsUrl ) { 	//获得新闻来源URL
        try {
            ...
            Document Doc = Jsoup.connect(NewsUrl)
                    ...
                    .timeout(3000)
                    .get();
            Element TitleEle = Doc.select("td[style=font-size: 22px; line-height: 30px; font-family: 黑体;]").first();
