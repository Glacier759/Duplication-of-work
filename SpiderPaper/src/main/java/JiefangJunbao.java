 ...
 */
public class JiefangJunbao {

    SaveXML savexml = new SaveXML();

    public JiefangJunbao( String newspaper ) {
    ...
    public void getNewsInfo( String NewsUrl ) { 	//获得新闻来源URL
        try {
            ...
            Document Doc = Jsoup.connect(NewsUrl)
                    ...
                    .timeout(3000)
                    .get();
            Element TitleEle = Doc.select("h1[style=line-height:140%;]").first();
            ...
            Elements IMGs = Doc.select("td[bgcolor=#E4E4E4]").select("img[src]");
