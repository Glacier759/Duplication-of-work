 ...
 */
public class HeilongjiangClass {

    SaveXML savexml = new SaveXML();

    public HeilongjiangClass( String newspaper ) {
    ...
    public void getNewsInfo( String NewsUrl ) { 	//获得新闻来源URL
        try {
            ...
            Document Doc = Jsoup.connect(NewsUrl)
                    ...
                    .timeout(3000)
                    .get();
            Element TitleEle = Doc.select("strong[style=font-size:23px;font-family:黑体;line-height:30px;]").first();
            ...
            Elements IMGs = Doc.select("table[width=96%]").select("img[src]");
