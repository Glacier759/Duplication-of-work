package com.glacier.dongying.DongyingZhijia;
...
/**
 * Created by glacier on 14-11-9.
 */
public class ZhijiaPageProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        Elements blockEles = document.select("td[class=fl_g]");
